//! The shared application error envelope.
//!
//! Every crate above the log speaks this one error shape — a stable code, a
//! human sentence, and a JSON context — so it lives here, in the one crate
//! they all already depend on. It is application-agnostic: nothing in it
//! names work, observations, or any other application vocabulary.
